    ...
    export default {
        ...
        methods: {
            ...
            setCitySlug() {
                ...
                axios.post('/api/frontend/city/set', {
                    'slug': this.nearCity.slug
                }).then(response => {
                    if (this.nearCity.slug == 'moskva') {
                        location.href = `https://dailyes.ru`
                    } else {
                        location.href = `https://${this.nearCity.slug}.dailyes.ru`
                    }
                })
            },
            showCitySelectPanel() {
