...
<script>
    ...
    export default {
        ...
        computed: {
            // recommendation() {
            //     return this.selectedRecommendation !== null ? this.selectedRecommendation : this.userRecommendation && this.selectedRecommendation !== null ? this.userRecommendation.bool : null
            // },
        },
        methods: {
            click(bool) {
                ...
                // if (this.selectedRecommendation == null) {
                    ...
                    axios.post(`/api/frontend/company/${res[2]}/recommendation`, {bool: bool})
                        .then(response => {
