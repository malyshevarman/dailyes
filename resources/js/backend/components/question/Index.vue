...
<script>
    ...
    export default {
        ...
        mounted() {
            // if (localStorage.getItem("newfiltersTableQuestions")) {
            //     this.filters = JSON.parse(localStorage.getItem("newfiltersTableQuestions"))
            // } else {
            //     localStorage.setItem("newfiltersTableQuestions", this.filters);
            // }
            this.fetchData()
        },
        methods: {
            ...
            fetchData() {
                ...
                // localStorage.setItem("newfiltersTableQuestions", JSON.stringify(this.filters));

                axios.post(`/api/backend/question/filter?page=${this.filters.pagination.current_page}`, this.filters)
                    .then(response => {
            ...
            destroy(id) {
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            axios.delete(`/api/backend/question/${id}`)
                                .then(response => {
                                    location.reload()
                                })
                                .catch(error => {
            ...
            toggle(id) {
                axios.post(`/api/backend/question/${id}/toggle`)
                    .then(response => {
                        location.reload()
                    })
                    .catch(error => {
