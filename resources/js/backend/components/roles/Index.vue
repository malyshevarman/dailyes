  ...
  <div class="container">
    ...
    <div class="card-body px-0">
          ...
          <tr>
            ...
            <th>
              <a
                href="#"
                class="text-dark"
                @click.prevent="sort('display_name')"
              >Роль</a>
              <i
                class="ml-1 fas"
                :class="{'fa-long-arrow-alt-down': filters.orderBy.column == 'display_name' && filters.orderBy.direction == 'asc', 'fa-long-arrow-alt-up': filters.orderBy.column == 'display_name' && filters.orderBy.direction == 'desc'}"
              />
            </th>
            <th class="d-none d-sm-table-cell">
              <a
          ...
          >
            ...
            <td>
              <div class="avatars-stack">
                <div
                  v-for="(user, index) in role.users.slice(0,4)"
                  class="avatar-sm"
                >
                  <img
                    class="img-avatar"
      ...
      >
        ...
        <p class="mb-0 mt-3">
          <strong>Роли не найдены</strong>
        </p>
        <p class="text-muted">
          Попробуйте применить фильтры или создать новую роль
        </p>
        <a
          class="btn btn-success"
...
export default {
  ...
  methods: {
    ...
    editRole(roleId) {
      location.href = `/admin/roles/${roleId}/edit`
    },
    getPermissionsCount() {
