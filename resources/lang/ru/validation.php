...
return [
    ...
    */
    ...
    'custom' => [
        'addresses.*.mon' => [
            'required_if' => 'В одном из адресов не установлен режим работы "Круглосуточно", требуется заполнить режим работы в :attribute, либо установить круглосуточный',
        ],
        'addresses.*.tues' => [
            'required_if' => 'В одном из адресов не установлен режим работы "Круглосуточно", требуется заполнить режим работы в :attribute, либо установить круглосуточный',
        ],
        ...
        'addresses.*.phone' => [
            'required' => 'В одном из адресов не указан основной номер телефона'
        ],
        'addresses.*.site' => [
            'required' => 'В одном из адресов не указан сайт'
        ]
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'image.id'                 => '"Превью"',
        'image'                 => '"Превью"',
        'start'                 => '"Дата проведения акции"',
        'addresses'             => '"Адрес"',
        'company.id'            => '"Компания"',
        'preview'               => '"Превью"',
        'text'                  => '"Текст"',
        'verification_email'    => '"Почта для верификации"',
        'button'                => '"Надпись на кнопке"',
        'summary'               => '"Краткое описание"',
        'link' => '"Ссылка"',
        'city.id' => '"Город"',
        'mobile.id' => '"Мобильный баннер"',
        'place.id' => '"Место размещения"',
        'download.id' => '"Баннер"',
        'width' => '"Ширина"',
        'height' => '"Высота"',
        'addresses.*.work'      => '"Круглосуточно"',
        'addresses.*.phone'     => '"Телефон"',
        'addresses.*.mon'       => '"Понедельник"',
        'addresses.*.tues'      => '"Вторник"',
        'addresses.*.wed'       => '"Среда"',
        'addresses.*.thurs'     => '"Четверг"',
        'addresses.*.fri'       => '"Пятница"',
        'addresses.*.sat'       => '"Суббота"',
        'addresses.*.sun'       => '"Воскресенье"',
    ],
];
