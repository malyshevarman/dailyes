<div class="report-panel">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <span class="report-panel__title">Почему вы жалуетесь на эту акцию?</span>
            </div>
            <form id="respform" action="{{ route('frontend.event.report', $event) }}" method="post"
                ...
                <div class="d-flex">
                    <input name="checkbox[4]" value="Акция не существует" type="checkbox" id="report5"
                           class="report-checkbox"/>
                    <label for="report5" class="label-report"></label>
                    <label for="report5" class="report-checkbox-text">Акция не существует</label>
                </div>
                <div class="d-flex">
            ...
            <h3 class="message-resp">Спасибо, что поделились данной информацией!<br>В ближайшее время мы проверим эту акцию.<br>
