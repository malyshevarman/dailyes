...
@section('header')
    @include('frontend.includes.headers.company-selection')
@endsection
...
@section('description', isset($selection->tile) ? $selection->tile->summary : $selection->slide->summary)
@section('image', $selection->background_url ?? '')
@section('url', route('frontend.city.event.category.show', empty($category) ? '' : $category))
                                        ...
                                        <div>
                                            ...
                                            @if (Request::input('categories') !== [])
                                                ...
                                                foreach ($company->categories as $company_category)
                                                    if ($company_category->id == Request::input('categories')[0]) {
                                            ...
                                            <a href="{{ route('frontend.city.company.category.show', $company->categories[0]) }}"
                                               class="events-block__group-a">
                                                <span class="events-block__group">{{ $company->categories[0]->name}}</span>
                                            </a>
                                            @else
            ...
            <div class="map-content">
                ...
                <div class="modal-body">
                    <div id="map" style="width: 100%; height: 600px">
                        <company-map :addresses="{{ $addresses }}" :modal="true"></company-map>
                    </div>
                </div>
            </div>
        </div>
