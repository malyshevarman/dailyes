...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="request-input" style="margin-top: 40px;">
                        @foreach ($requestInput as $key => $input)
                            @if ($key == 'Сортировано по:')
                                @if (Request::input('sort-raiting'))
                                    <li>
                                        <span class="filter_tag">
                                            <a href="{{route('frontend.company.index', Request::except('sort-raiting'))}}">
                                                {{ $input }} 
                                ...
                                @elseif (Request::input('sort-views'))
                                    <li>
                                        <span class="filter_tag">
                                            <a href="{{route('frontend.company.index', Request::except('sort-views'))}}">
                                                {{ $input }} 
                            ...
                            @else
                                @if ($key == 'По дате:')
                                    <li>
                                        <span class="filter_tag">
                                            <a href="{{route('frontend.company.index', Request::except('date'))}}">
                                                {{ $input }}
                                                <i class="clear_filter">&times;</i>
                                            </a>
                                        </span>
                                ...
                                @elseif($key == 'Категории:')
                                        ...
                                        <li>
                                            <span class="filter_tag">
                                                <a href="{{route('frontend.company.index', Request::except('tags.' . array_search($cat['id'], Request::input('tags'))))}}">
                                                    {{ $cat['name'] }}
                                                    <i class="clear_filter">&times;</i>
                                                </a>
                                            </span>
                                ...
                                @elseif($key == 'Адрес:')
                                    <li>
                                        <span class="filter_tag">
                                            <a href="{{route('frontend.company.index', Request::except('location'))}}">
                                                {{ $input }}
                                                <i class="clear_filter">&times;</i>
                                            </a>
                                        </span>
                        ...
                        <li>
                            <span class="filter_tag">
                                <a href="{{route('frontend.company.index')}}">
                                    Сбросить все
                                    <!-- <i class="clear_filter">&times;</i> -->
                                </a>
                            </span>
                                        ...
                                        <a href="{{ route('frontend.city.company.tag.show', $company->tags[0]) }}">
                                            <div class="search-panel__company-group">
                                                ...
                                                (
                                                    ...
                                                    $company->tags->first(function($item) {
                            ...
                            <div class="col-md-12 bot-panel">
                                <div class="row justify-content-center">
                                    <div class="col-lg-6 col-sm-8" style="display:none;">
                                        {{ $companies->appends(Request::all())->links('frontend.includes.pagination', ['paginator' => $companies]) }}
                                    </div>
    ...
    <div class="container seoblock">
        @include('frontend.includes.seo.companies_list_page')
    </div>
    ...
    <div class="modal fade map-modal" id="map-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <modal-map-index
                :city="{{json_encode($city)}}"></modal-map-index>
        </div>
    </div>
@endsection
@push('after-scripts')
