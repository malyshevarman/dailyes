    ...
    <table width="540 " border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
        ...
        <tr>
            <td width="640" align="left" style="font-family: 'Montserrat', sans-serif;
                                                ...
                                                font-weight: normal;
            ">
                <h1>Модерация акции</h1><br>
                Уважаемый(ая) <b>{{$data['user']->name}}{{$data['user']->surname ? ' ' . $data['user']->surname : ''}}</b>!
                <br>
                <br>
                Вы заполнили заявку на публикацию акции <b>"{{$data['event']->name}}"</b> от лица компании <a style="font-family: 'Montserrat', sans-serif;
            font-style: normal;
            font-weight: bold;
            font-size: 14px;
            line-height: 17px;
            ...
            text-decoration: none;" class="link" href="https://{{is_null($data['user']->city_slug) ? 'dailyes.ru' : $data['user']->city_slug . '.dailyes.ru'}}{{ route('frontend.company.show', $data['event']->company, false) }}"><b>"{{$data['event']->company->name}}"</b></a>. 
                <br> 
                После успешной прохождения модерации, она отобразится на <a style="font-family: 'Montserrat', sans-serif;
            font-style: normal;
            font-weight: bold;
            font-size: 14px;
            line-height: 17px;
