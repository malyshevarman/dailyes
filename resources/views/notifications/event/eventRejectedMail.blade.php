    ...
    <table width="540 " border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
        ...
        <tr>
            <td width="640" align="left" style="font-family: 'Montserrat', sans-serif;
                                                ...
                                                font-weight: normal;
            ">
                <h1>К сожалению, ваша акция не прошла модерацию</h1><br>
                Уважаемый(ая) <b>{{$data['user']->name}}{{$data['user']->surname ? ' ' . $data['user']->surname : ''}}</b>!<br>
                <br>

                Созданная вами акция <a style="font-family: 'Montserrat', sans-serif;
            font-style: normal;
            font-weight: bold;
            font-size: 14px;
            line-height: 17px;
            color:#1D86E0;
            text-decoration: none;" class="link" href="https://{{is_null($data['user']->city_slug) ? 'dailyes.ru' : $data['user']->city_slug . '.dailyes.ru'}}{{route('cabinet.event.edit', $data['event'], false)}}"><b>"{{$data['event']->name}}"</b></a> не прошла модерацию, по причине нарушения <a style="font-family: 'Montserrat', sans-serif;
            font-style: normal;
            font-weight: bold;
            font-size: 14px;
            line-height: 17px;
            ...
            line-height: 17px;
            color:#1D86E0;
            text-decoration: none;" class="link" href="https://{{is_null($data['user']->city_slug) ? 'dailyes.ru' : $data['user']->city_slug . '.dailyes.ru'}}{{ route('cabinet.event.edit', $data['event'], false) }}">ссылке</a>.
