...
class CommentAnswerRejected extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        if ($this->answer->comment->commented_type == Event::class) {
            $subject = "Ваш комментарий к отзыву по вашей акции не прошёл модерацию";
        } else if ($this->answer->comment->commented_type == Company::class) {
            $subject = "Ваш комментарий к отзыву по вашей компании не прошёл модерацию";
        }
        ...
        return (new MailMessage)
            ...
            ->view('notifications.commentAnswer.commentAnswerRejectedMail', ['data' => ['answer' => $this->answer, 'user' => $notifiable]]);
    }
