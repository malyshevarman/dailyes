...
class CommentAnswerPublished extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        if ($this->answer->comment->commented_type == Event::class) {
            $subject = "Ваш комментарий к отзыву по вашей акции успешно опубликован";
        } else if ($this->answer->comment->commented_type == Company::class) {
            $subject = "Ваш комментарий к отзыву по вашей компании успешно опубликован";
        }
        ...
        return (new MailMessage)
            ...
            ->view('notifications.commentAnswer.commentAnswerPublishedMail', ['data' => ['answer' => $this->answer, 'user' => $notifiable]]);
    }
