...
class EventFavoriteWillEnd extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject('Заканчивается период действия акции из списка избранных')
            ...
            ->view('notifications.event.eventFavoriteWillEndMail', ['data' => ['event' => $this->event, 'user' => $notifiable]]);
    }
