...
use App\Event;
class EventEnded extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject('Период действия вашей акции закончился')
            ...
            ->view('notifications.event.eventEndedMail', ['data' => ['event' => $this->event, 'user'=> $notifiable]]);
    }
