...
class AdvertisingPageCallbackOrdered extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        //     ->line('Ссылка на сайт: ' . (isset($this->data['site_link']) ? $this->data['site_link'] : ''))
        ...
        return (new MailMessage)
            ...
            ->view('notifications.advertisingPageCallbackOrderedMail', ['data' => ['user' => $notifiable, 'data' => $this->data]]);
    }
}
