...
Route::middleware('auth')->group(function () {
    Route::group(['namespace' => 'Roles'], function() {
        ...
        Route::group(['prefix' => 'admin/roles'], function() {
            Route::view('/', 'backend.roles.index')->middleware('permission:read-roles');
            Route::view('/create', 'backend.roles.create')->middleware('permission:create-roles');
            Route::view('/{role}/edit', 'backend.roles.edit')->middleware('permission:update-roles');
        });
        ...
        Route::group(['prefix' => 'api/roles'], function() {
            ...
            Route::get('/get-role-modules-permissions/{role}','RoleController@getRoleModulesPermissions');
